<div class="col-md-9 embed-responsive">
    <div class="p-6">
            ...
            <div class="card p-2">
                <div id="depthchart" style="height: 600px; width:max-width"></div>
            </div>
</div>
...
<script>
    ...
    // Add data
    chart.dataSource.url = "https://poloniex.com/public?command=returnOrderBook&currencyPair=BTC_ETH&depth=1000";
